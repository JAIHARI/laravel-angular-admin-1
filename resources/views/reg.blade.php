...
<head>
  ...
  <link rel="stylesheet" href="styles/vendor-ac7f6b898b.css">

  <link rel="stylesheet" href="styles/auth-a200a050c1.css">
</head>
<body>
<main class="auth-main">
  <div class="auth-block">
    ...
    @if (count($errors) > 0)
    <div class="alert bg-danger closeable" role="alert"><button type="button" class="close" aria-label="Close"><span aria-hidden="true">×</span></button> <strong>Oh snap!</strong>
            <ul>
